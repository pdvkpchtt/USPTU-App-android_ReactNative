...
import getAuditors from './api/getAuditors'
import getGroups from './api/getGroups'
import getPrepods from './api/getPrepods'
import ListSearch from './ui/ListSearch'

const SearchList = ({ navigation, filter }) => {
  ...
  return <ListSearch items={searchItems} isEmpty={isEmpty} refreshing={loading} navigation={navigation} />
}
