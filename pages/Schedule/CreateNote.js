...
const CreateNote = ({ navigation }) => {
  ...
  // isTheme.includes('_dark') ? SwitchTheme(isTheme).checkIcon : '#fff'
  useEffect(() => {
      ...
      <Layout>
        ...
        >
          ...
          <View style={{ paddingHorizontal: 12 }}>
            <TextSmall
              color={isTheme.includes('theme_usual') ? SwitchTheme(isTheme).textSec : SwitchTheme(isTheme).textOuterSec}
            >
